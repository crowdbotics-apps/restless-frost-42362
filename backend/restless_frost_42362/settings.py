"""
Django settings for restless_frost_42362 project.
...
ROOT_URLCONF = 'restless_frost_42362.urls'
...
WSGI_APPLICATION = 'restless_frost_42362.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_frost_42362 API",
    "DESCRIPTION": "API documentation for restless_frost_42362 App",
    "VERSION": "v1",
}
